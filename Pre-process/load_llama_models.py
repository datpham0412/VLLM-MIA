import os
import sys
sys.path.append("/fred/oz402/tiend/VLLM-MIA/")

from typing import Type, Tuple
from transformers import PreTrainedTokenizer, PreTrainedModel, AutoTokenizer, CLIPImageProcessor, CLIPVisionModel, AutoModelForCausalLM
...
if __name__ == "__main__":
    ...
    # === LLaVA model ===
    llava_local = "/fred/oz402/tiend/VLLM-MIA/target_models/open_llama_7b "
    llava_remote = "openlm-research/open_llama_7b"
    ...
    clip_path = "/fred/oz402/tiend/VLLM-MIA/target_models/pretrained/clip-vit-large-patch14-336"
