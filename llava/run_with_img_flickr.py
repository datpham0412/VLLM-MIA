...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default='/fred/oz402/aho/VLLM-MIA/Data/augmented_Flickr')
    parser.add_argument("--output_dir", type=str, default="/fred/oz402/aho/VLLM-MIA/Result/augmented_flickr_MIA")
